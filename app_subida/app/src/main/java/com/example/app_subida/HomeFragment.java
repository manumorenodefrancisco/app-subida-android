...
public class HomeFragment extends Fragment {
    ...
    public void cargarDatosUsuario() {
        Executors.newSingleThreadExecutor().execute(() -> {
            com.example.app_subida.data.entities.Usuario usuario = database.usuarioDao().getUsuario();
            ...
            requireActivity().runOnUiThread(() -> {
                if (usuario != null) {
                    ...
                    int nivel = com.example.app_subida.data.entities.Usuario.calcularNivel(usuario.estadisticas.xpTotal);
    ...
    private void cargarRegistrosSistema() {
        Executors.newSingleThreadExecutor().execute(() -> {
            List<com.example.app_subida.data.entities.RegistroSistema> logs = database.registroSistemaDao().getRecientes(4);
            ...
            requireActivity().runOnUiThread(() -> {
                ...
                for (com.example.app_subida.data.entities.RegistroSistema log : logs) {
    ...
    private void crearVistaLog(com.example.app_subida.data.entities.RegistroSistema log, LinearLayout container) {
        ...
        tvHora.setText(com.example.app_subida.data.utils.FechaUtils.formatearParaLog(log.fechaHora));
